                                ...
                                <div class="row">
                                    <div class="col-lg-12">
                                        <div class="card">
                                            ...
                                            <div class="card-body">
                                                <form action="<?=base_url()?>News/adding_news" method="POST" enctype="multipart/form-data">
                                                    <div class="row">
                                                        <div class="col-md-4">
                                                            <div class="form-group">
                                                                <label>News Heading</label>
                                                                <input type="text" class="form-control" name="news_heading" required="">
                                                            </div>
                                                        </div>
                                                        <div class="col-md-8">
                                                            <div class="form-group">
                                                                <label>News Description</label>
                                                                <input type="text" class="form-control" name="news_description" maxlength="250" id="defaultconfig" required="">
                                                            </div>
                                                        </div>
                                                    </div>
