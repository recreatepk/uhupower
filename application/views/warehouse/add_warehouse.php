                                    ...
                                    <div class="col-lg-12">
                                        <div class="card">
                                            <div class="card-header">
                                                <h4 class="card-title">Add a Warehouse</h4>
                                                <p class="text-muted mb-0">Add a new Warehouse </p>
                                            </div><!--end card-header-->
                                            <div class="card-body">
                                                <form action="<?=base_url()?>Warehouse/adding_warehouse" method="POST" enctype="multipart/form-data">
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" class="form-control" name="warehouse_address" maxlength="250" id="defaultconfig" required="">
                                                            </div>
                                                        </div>
                                                    </div>
...
<script>
    $(document).ready(function() {
      ...
      Toast.fire({
        icon: 'success',
        title: 'A new Warehouse is added'
      });
    });
</script>
<?
...
<script>
  ...
  var currentPage = "1"; // Example: If you're on 1, set it to "1"
