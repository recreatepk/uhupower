                                    ...
                                    <div class="col-lg-12">
                                        <div class="card">
                                            <div class="card-header">
                                                ...
                                                <p class="text-muted mb-0">Edit a new Store </p>
                                            </div><!--end card-header-->
                                            <div class="card-body">
                                                <form action="<?=base_url()?>Store/editing_store/<?=$stores[0]['store_id']?>" method="POST" enctype="multipart/form-data">
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                <label>Store Name *</label>
                                                                <input type="text" value="<?=$stores[0]['store_name']?>" class="form-control" name="store_name" required="">
                                                            </div>
                                                        </div>
                                                    </div>
