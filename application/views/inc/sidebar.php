 ...
 <div class="left-sidenav" >
            ...
            <div class="menu-content h-100" data-simplebar>
                <ul class="metismenu left-sidenav-menu">
                    ...
                    <?php if (in_array(1, $_SESSION['module_id']) || in_array(2, $_SESSION['module_id']) || in_array(3, $_SESSION['module_id']) || in_array(7, $_SESSION['module_id'])){ ?>
                    <li>
                        ...
                        <ul class="nav-second-level" aria-expanded="false">
                            <li>
                                ...
                                <ul class="nav-second-level" aria-expanded="false">
                                    <?php if (in_array(15, $_SESSION['module_id'])){ ?>
                                    <li><a  href="<?=base_url()?>Product/product_cat">View Categories</a></li>
                                    <?php }?>
                                    <?php if (in_array(18, $_SESSION['module_id'])){ ?>
                            ...
                            <li>
                                ...
                                <ul class="nav-second-level" aria-expanded="false">
                                    <?php if (in_array(1, $_SESSION['module_id'])){ ?>
                                    <li><a  href="<?=base_url()?>Product">View Products</a></li>
                                    <?php }?>
                                    <?php if (in_array(7, $_SESSION['module_id'])){ ?>
                    ...
                    <li>
                        ...
                        <ul class="nav-second-level" aria-expanded="false">
                            <?php if (in_array(32, $_SESSION['module_id'])){ ?>
                            <li>
                    ...
                    <?php if (in_array(48, $_SESSION['module_id'])){ ?>
                    <li>
                    ...
                    <?php if (in_array(19, $_SESSION['module_id']) || in_array(20, $_SESSION['module_id']) || in_array(21, $_SESSION['module_id']) || in_array(22, $_SESSION['module_id'])){ ?>
                    <hr class="hr-dashed hr-menu">
                    ...
                    <?php if (in_array(38, $_SESSION['module_id']) || in_array(39, $_SESSION['module_id'])){ ?>
                    <li>
                        ...
                        <ul class="nav-second-level" aria-expanded="false">
                            <?php if (in_array(38, $_SESSION['module_id'])){ ?>
                            <li>
                                <a href="<?=base_url()?>Quotation"><i class="ti-control-record"></i>View Quotation</a>
                            </li>
                            <?php }?>
                            <?php if (in_array(39, $_SESSION['module_id'])){ ?>
                            <li>
                    ...
                    <li>
                        ...
                        <ul class="nav-second-level" aria-expanded="false">
                            <li>
                                ...
                                <ul class="nav-second-level" aria-expanded="false">
                                    <?php if (in_array(25, $_SESSION['module_id'])){ ?>
                                    <li><a href="<?=base_url()?>Purchase_order">View PO</a></li>
                                    <?php }?>
                                    <?php if (in_array(23, $_SESSION['module_id'])){ ?>
                    ...
                    <?php if (in_array(25, $_SESSION['module_id']) || in_array(23, $_SESSION['module_id'])){ ?>
                    <hr class="hr-dashed hr-menu">
                    ...
                    <li>
                        ...
                        <ul class="nav-second-level" aria-expanded="false">
                            <?php if (in_array(81, $_SESSION['module_id'])){ ?>
                            <li>
                                ...
                                <ul>
                                    ...
                                    <?php }?>
                                    <?php if (in_array(89, $_SESSION['module_id'])){ ?>
                                    <li>
                    ...
                    <?php }?>
                     ...
                     <?php if (in_array(43, $_SESSION['module_id']) || in_array(44, $_SESSION['module_id'])){ ?>
                    ...
                    <?php }?>
                    <?php if (in_array(59, $_SESSION['module_id']) || in_array(60, $_SESSION['module_id']) || in_array(55, $_SESSION['module_id']) || in_array(56, $_SESSION['module_id'])){ ?>
                    <li>
                        ...
                        <ul class="nav-second-level" aria-expanded="false">
                            <li>
                                ...
                                <ul class="nav-second-level" aria-expanded="false">
                                    <?php if (in_array(59, $_SESSION['module_id'])){ ?>
                                    <li><a href="<?=base_url()?>Expense/expense_category">View Categories</a></li>
                                    <?php }?>
                                    <?php if (in_array(60, $_SESSION['module_id'])){ ?>
                            ...
                            <li>
                                ...
                                <ul class="nav-second-level" aria-expanded="false">
                                    <?php if (in_array(55, $_SESSION['module_id'])){ ?>
                                    <li><a href="<?=base_url()?>Expense">View Expense</a></li>
                                    <?php }?>
                                    <?php if (in_array(56, $_SESSION['module_id'])){ ?>
                    ...
                    <?php }?>
                    <?php if (in_array(4, $_SESSION['module_id']) || in_array(8, $_SESSION['module_id']) || in_array(63, $_SESSION['module_id']) || in_array(83, $_SESSION['module_id']) || in_array(84, $_SESSION['module_id']) || in_array(87, $_SESSION['module_id']) ){ ?>
                    <hr class="hr-dashed hr-menu">
                    <li id="hrm" class="menu-label my-2">HRM</li>
                    <?php if (in_array(83, $_SESSION['module_id']) || in_array(84, $_SESSION['module_id'])){ ?>
                    <li>
                        ...
                        <ul class="nav-second-level" aria-expanded="false">
                            <?php if (in_array(83, $_SESSION['module_id'])){ ?>
                            <li>
                                <a href="<?=base_url()?>Department"><i class="ti-control-record"></i>View Departments</a>
                            </li>
                            <?php }?>
                            <?php if (in_array(84, $_SESSION['module_id'])){ ?>
                            <li>
                    ...
                    <?php }?>
                    <?php if (in_array(4, $_SESSION['module_id']) || in_array(8, $_SESSION['module_id'])){ ?>
                    <li>
                        ...
                        <ul class="nav-second-level" aria-expanded="false">
                            <?php if (in_array(4, $_SESSION['module_id'])){ ?>
                            <li>
                                <a href="<?=base_url()?>User/user"><i class="ti-control-record"></i>View Users</a>
                            </li>
                            <?php }?>
                            <?php if (in_array(8, $_SESSION['module_id'])){ ?>
                            <li>
                    ...
                    <?php }?>
                    <?php if (in_array(63, $_SESSION['module_id'])){ ?>
                    <li>
                    ...
                    <?php }?>
                    <?php if (in_array(87, $_SESSION['module_id']) && $_SESSION['id'] != 1){ ?>
                    <li>
                        ...
                        <ul class="nav-second-level" aria-expanded="false">
                            <?php if (in_array(87, $_SESSION['module_id'])){ ?>
                            <li>
                    ...
                    <?php }?>
                     <?php if (in_array(75, $_SESSION['module_id']) || in_array(76, $_SESSION['module_id'])){ ?>
                    <li>
                        ...
                        <ul class="nav-second-level" aria-expanded="false">
                            <?php if (in_array(75, $_SESSION['module_id'])){ ?>
                            <li>
                                <a href="<?=base_url()?>Salary"><i class="ti-control-record"></i>View Salaries</a>
                            </li>
                            <?php }?>
                            <?php if (in_array(76, $_SESSION['module_id'])){ ?>
                            <li>
                   ...
                   <li>
                        ...
                        <ul class="nav-second-level" aria-expanded="false">
                            <?php if (in_array(91, $_SESSION['module_id'])){ ?>
                            <li>
                                <a href="<?=base_url()?>Complaint"><i class="ti-control-record"></i>View Complaint</a>
                            </li>
                            <?php }?>
                            <?php if (in_array(90, $_SESSION['module_id'])){ ?>
                            <li>
                    ...
                    <?php if (in_array(94, $_SESSION['module_id']) || in_array(95, $_SESSION['module_id'])){ ?>
                    <li>
                        ...
                        <ul class="nav-second-level" aria-expanded="false">
                            <?php if (in_array(94, $_SESSION['module_id'])){ ?>
                            <li>
                                <a href="<?=base_url()?>Service_quote"><i class="ti-control-record"></i>View Quotation</a>
                            </li>
                            <?php }?>
                            <?php if (in_array(95, $_SESSION['module_id'])){ ?>
                            <li>
                    ...
                    <li>
                        ...
                        <ul class="nav-second-level" aria-expanded="false">
                            <li>
                                ...
                                <ul class="nav-second-level" aria-expanded="false">
                                    <?php if (in_array(67, $_SESSION['module_id'])){ ?>
                    ...
                    <?php }?>
                    <?php if (in_array(30, $_SESSION['module_id']) || in_array(28, $_SESSION['module_id'])){ ?>
                    <hr class="hr-dashed hr-menu">
                    ...
                    <li>
                        ...
                        <ul class="nav-second-level" aria-expanded="false">
                            ...
                            <li>
                                ...
                                <ul class="nav-second-level" aria-expanded="false">
                                    <?php if (in_array(30, $_SESSION['module_id'])){ ?>
                                    <li><a id="" href="<?=base_url()?>Warehouse">View Warehouses</a></li>
                                    <?php }if (in_array(28, $_SESSION['module_id'])){ ?>
                    ...
                    <?php }?>
                    <?php if (in_array(11, $_SESSION['module_id']) || in_array(9, $_SESSION['module_id'])){ ?>
                    <li>
                        ...
                        <ul class="nav-second-level" aria-expanded="false">
                            <?php if (in_array(11, $_SESSION['module_id'])){ ?>
                            <li>
                                <a href="<?=base_url()?>User/user_group"><i class="ti-control-record"></i>User Groups</a>
                            </li>
                            <?php }?>
                            <?php if (in_array(9, $_SESSION['module_id'])){ ?>
                            <li>
                    ...
                    <?php if (in_array(51, $_SESSION['module_id'])){ ?>
                    <li>
                     ...
                     <?php }?>
                    <?php if (in_array(13, $_SESSION['module_id'])){ ?>
                    <li>
