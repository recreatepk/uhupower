                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="page-title-box">
                                <div class="row">
                                    <div class="col">
                                        <h4 class="page-title">Print Gate Pass</h4>
                                        <ol class="breadcrumb">
                                    ...
                                    <div class="col-lg-12">
                                        <div class="card">
                                            <div class="card-header">
                                                <h4 class="card-title">GP</h4>
                                                <p class="text-muted mb-0">Select Time Frame</p>
                                                <form action="<?=base_url()?>Quotation/gate_pass" method="POST">
                                                    <div class="row">
                                                        <div class="col-sm-10">
                                                ...
                                                <div class="table-responsive">
                                                    <table class="table table-hover mb-0">
                                                        ...
                                                        <tbody>
                                                            ...
                                                            <tr>
                                                                <td><?=$count?></td>
                                                                <td>GP - 0<?=$dc['sell_dc_id']?></td>
                                                                <td><?=date('d-M-Y',strtotime($dc['date']))?></td>
                                                                <td>
                                                                    <?=$retVal = ($dc['status'] == 1) ? "<span class='badge badge-pill badge-info'><i class='fas fa-ban'></i> Not Authurized</span>" : "<span class='badge badge-pill badge-success'><i class='fas fa-check'></i> Authrized</span>" ;?>
                                                                </td>
