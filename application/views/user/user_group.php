                                                ...
                                                <table class="table table-hover mb-0">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        ?>
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    ...
                                                                    if ($user_group['user_group_id'] == 1) {
                                                                        echo "System generated Group (Can't modify)";
                                                                    ...
                                                                    ?>
                                                                        ...
                                                                        <div class="dropdown-menu">
                                                                            <?php if (in_array(10, $_SESSION['module_id'])) { ?>
                                                                                ...
                                                                                <a class="dropdown-item" data-toggle="modal" data-target="#copyRoleModal<?= $user_group['user_group_id'] ?>"><i class="mdi mdi-grease-pencil"></i> Copy/Duplicate Group</a>
                                                            ...
                                                            <!-- Modal -->
                                                            <div class="modal fade" id="copyRoleModal<?= $user_group['user_group_id'] ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                                                <div class="modal-dialog" role="document">
                                                                    <div class="modal-content">
                                                                        <div class="modal-header">
                                                                            <h5 class="modal-title" id="exampleModalLabel">Duplicate Group</h5>
                                                                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                                                <span aria-hidden="true">&times;</span>
                                                                            </button>
                                                                        </div>
                                                                        <form action="<?= base_url() ?>user/duplicate_group/<?= $user_group['user_group_id'] ?>" method="POST">
