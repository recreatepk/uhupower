                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="col-md-3">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <input type="number" class="form-control" value="<?=$users[0]['allowed_leaves']?>" name="allowed_leaves">
                                                                    </div>
                                                                </div>
                                                                ...
                                                                <div class="col-md-6">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <input type="text" class="form-control" value="<?=$users[0]['bank_name']?>" name="bank_name">
                                                                    </div>
                                                                </div>
                                                                ...
                                                                <div class="col-md-3">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <input type="text" class="form-control" value="<?=$users[0]['bank_account_number']?>" name="bank_account_number">
                                                                    </div>
                                                                </div>
