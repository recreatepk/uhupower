                            ...
                            <div class="card">
                                                        ...
                                                        <optgroup label="Select Customer">
                                                            <?
                                                                foreach ($suppliers as $supplier) {
                                                                    if ($supplier['cat'] == 2) {
                                                            ?>
                                                            <option value="<?=$supplier['sup_cus_id']?>" <?=$retVal = ($supplier['sup_cus_id'] == $sup[0]['sup_cus_id']) ? 'selected' : '' ;?>><?=$supplier['sup_cus_company']?> - <?=$supplier['sup_cus_name']?></option>
                                                            <?
                                                                    }
                                                                }
                                                            ?>
                                ...
                                <div class="card-body" id="printme">
                                    <div class="col-sm-12">
                                        ...
                                        <h4 style="text-align:center;">Account of <?=$sup[0]['sup_cus_name'] . ' ' . $sup[0]['sup_cus_phone1']?></h4>
                                    </div>
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-hover table-bordered mb-0">
                                                ...
                                                foreach ($combinedArray as $item) {
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <?
                                                                if (isset($item['purchase_order_id'])) {
                                                                    echo $item['purchase_order_product_cost'];
                                                                }
                                                                if (isset($item['invoice_id'])) {
                                                                    echo $item['invoice_cost'];
                                                                }
                                                                if (isset($item['render_service_id'])) {
                                                        ...
                                                        <td>
                                                            <?
                                                            $balanceValue = $balance; // Assuming $balance contains the balance value
                                                            if ($balance < 0) {
                                                                $balanceValue = "<code>";
                                            ...
                                            <tfoot>
                                                <tr>
                                                    <td colspan="5" style="text-align: center; vertical-align: middle;font-size: 25px;border-top: 1px solid"><b>TOTAL</b></td>
                                                    <td style="border-bottom: 3px double; border-top: 1px solid"><b><?=$total_debit?> (PKR)</b></td>
                                                    <td style="border-bottom: 3px double; border-top: 1px solid"><b><?=$total_credit?> (PKR)</td>
                                                    <td style="border-bottom: 3px double; border-top: 1px solid"><b><?=$balanceValue?> (PKR)</b></td>
                                                </tr>
                                            </tfoot>
                                        </table><!--end /table-->
                                        <div class="float-right">
                                        <button onclick="printContent('printme');" class="btn btn-info no-print"><i class="fa fa-print"></i> Print</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
