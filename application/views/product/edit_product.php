                                    ...
                                    <div class="col-lg-12">
                                        <div class="card">
                                            <div class="card-header">
                                                ...
                                                <p class="text-muted mb-0">Edit Product <code>(Edit product Infomartion)</code></p>
                                            </div><!--end card-header-->
                                            <div class="card-body">
                                                <form action="<?=base_url()?>Product/editing_product/<?=$product[0]['product_id']?>" method="POST" enctype="multipart/form-data">
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                <label>Product Name *</label>
                                                                <input type="text" class="form-control" name="product_name" value="<?=$product[0]['product_name']?>" required="">
                                                            </div>
                                                        </div>
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                        ...
                                                        <div class="col-md-12">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" class="form-control" value="<?=$product[0]['product_description']?>" name="product_description" maxlength="250" id="defaultconfig">
                                                            </div>
                                                        </div>
                                                    </div>
...
<script>
    $(document).ready(function() {
      ...
      Toast.fire({
        icon: 'success',
        title: 'Product Information changned successfully'
      });
    });
</script>
<?
