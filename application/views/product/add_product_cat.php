                                ...
                                <div class="row">
                                    <div class="col-lg-12">
                                        <div class="card">
                                            ...
                                            <div class="card-body">
                                                <form action="<?=base_url()?>Product/adding_product_cat" method="POST" enctype="multipart/form-data">
                                                    <div class="row">
                                                        <div class="col-md-4">
                                                        ...
                                                        <div class="col-md-8">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" class="form-control" name="product_category_desc" maxlength="250" id="defaultconfig">
                                                            </div>
                                                        </div>
                                                    </div>
...
<script>
    $(document).ready(function() {
      ...
      Toast.fire({
        icon: 'success',
        title: 'A new Product Category added'
      });
    });
</script>
<?
